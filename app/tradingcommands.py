...
class UserImportCommand(Command):
    SUMMARY = "to import actives trades from a JSON file, previously generated by export command"
    HELP = (
        "param1: <filename> Specify the full-path filename (optional) (default /tmp/siis_trades.json)"
    )
    ...
    def execute(self, args):
        # ie: ":import json /home/local/my_trades.json"
