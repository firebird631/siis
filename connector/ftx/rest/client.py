...
class FtxClient:
    ...
    def modify_order(self, existing_order_id: Optional[str] = None,
    ...
    def cancel_orders(self, market_name: str = None,
    ...
    def get_all_trades(self, market: str, start_time: float = None, end_time: float = None) -> List:
        ...
        while True:
            ...
            end_time = min(datetime.strptime(t['time'], '%Y-%m-%dT%H:%M:%S.%f+00:00').replace(
    ...
    def get_historical_prices(self, market: str, resolution: int = 300, start_time: float = None,
