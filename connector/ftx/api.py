...
from .wsapi import FtxWebSocketClient


class FtxClient:

    def __init__(self, base_url: str = "https://ftx.com/api/",
                 api_key: Optional[str] = None, api_secret: Optional[str] = None,
                 subaccount_name: Optional[str] = None, ws_queue_size: int = 1024) -> None:
    ...
    @authentication_required
    def get_conditional_order_history(self, market: Optional[str] = None, side: Optional[str] = None,
                                      type: Optional[str] = None, order_type: Optional[str] = None,
                                      start_time: Optional[float] = None,
                                      end_time: Optional[float] = None) -> List[dict]:
        return self._get(
    ...
    def get_fills(self,
                  ...
                  order_id: Optional[float] = None) -> List[dict]:
    ...
    def get_all_trades(self,
        ...
        while True:
            ...
            end_time = min(datetime.strptime(t['time'], '%Y-%m-%dT%H:%M:%S.%f').replace(
                tzinfo=UTC()) for t in response).timestamp()
    ...
    def get_funding_rates(self, future: Optional[str] = None, 
                          start_time: Optional[float] = None,
                          end_time: Optional[float] = None) -> List[dict]:
        return self._get('funding_rates', dict(
            future=future,
            start_time=start_time,
            end_time=end_time))
