...
class Statistic(Tool):
    ...
    def run(self, options):
        ...
        from_date = self._from_date.replace(tzinfo=UTC())
        to_date = self._to_date.replace(tzinfo=UTC())
    ...
    def add_trade(self, trade, interval):
        ...
        # 'profit-loss-pct': round((self.net_profit_loss_rate() * 100.0, 2),  # minus fees
