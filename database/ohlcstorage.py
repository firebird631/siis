...
# Candle/OHLC storage, query and streaming per market from database
...
#     @note Generic SQL.
#     @deprecated No use because it was planned to move OHLC implementation part here. Not really important.
#         And will need PostgreSQL and MySQL distinct implementations.
#
#     Delete if timestamp :
...
#         """
#         if data[3] < 60:
#             # never store OHLC lesser than 1m
#             return
#
#         with self._mutex:
...
class OhlcStreamer(object):
    ...
    @note Generic SQL. It works with PostgreSQL or MySQL.
    """
