...
# Logarithmic Volume Profile indicator based on tick or trade update
...
class LogTickVolumeProfileIndicator(LogVolumeProfileBaseIndicator):
    """
    Logarithmic Volume Profile indicator based on tick or trade update.
    """

    def __init__(self, timeframe:  float, length:  int = 10, sensibility: int = 10, volume_area: float = 70):
        super().__init__("logtickvolumeprofile", timeframe, length, sensibility, volume_area)
