...
logger = logging.getLogger('siis.fetcher.bybitfutures')
error_logger = logging.getLogger('siis.error.fetcher.bybitfutures')


class ByBitFuturesFetcher(Fetcher):
    """
    ...
    def __init__(self, service):
        super().__init__("bybitfutures.com", service)
