...
import logging
logger = logging.getLogger('siis.fetcher.binancefutures')
error_logger = logging.getLogger('siis.error.fetcher.binancefutures')


class BinanceFuturesFetcher(Fetcher):
    """
